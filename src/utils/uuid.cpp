...
auto bytes(std::size_t quantity) -> std::string
{
  ...
  static std::uniform_int_distribution<int> distribution(std::numeric_limits<uint8_t>::min(), std::numeric_limits<uint8_t>::max()); // MSVC doesn't like std::uniform_int_distribution<uint8_t>
